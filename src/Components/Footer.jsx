  ...
  return (
    <Box
      sx={{
        ...
        mx: 'auto',
        zIndex: 1000, // اطمینان از نمایش بالای سایر عناصر
        overflow: 'hidden',
    ...
    >
      {isMobile ? (
        ...
        >
          ...
          <PriceBox year="2010" price="$1" isMobile={isMobile} />
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <Typography
          ...
          sx={{
            ...
            fontSize: current ? (isMobile ? '2.2rem' : '1.8rem') : isMobile ? '1.5rem' : '1.8rem',
